...
export const metadata: Metadata = {
  title: `Ceiling Fan Installation in Nashville, TN | Express Electric`,
  description: `Professional ceiling fan installation services in Nashville. Express Electric delivers expert results with quality workmanship and customer satisfaction guaranteed.`,
  openGraph: {
    title: `Ceiling Fan Installation in Nashville, TN`,
    description: `Professional ceiling fan installation services in Nashville. Express Electric delivers expert results with quality workmanship and customer satisfaction guaranteed.`,
    type: 'website',
  },
}
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-semibold">Ceiling Fan Installation</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Professional ceiling fan installation services in Nashville. Express Electric delivers expert results with quality workmanship and customer satisfaction guaranteed.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Ceiling Fan Installation example 1"
                    fill
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Ceiling Fan Installation example 2"
                    fill
                    className="object-cover"
                    loading="lazy"
                  />
                ...
                <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Ceiling Fan Installation example 3"
                    fill
                    className="object-cover"
                    loading="lazy"
                  />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Professional Ceiling Fan Installation in Nashville
              </h2>
              <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
                <p>
                  At Express Electric, we specialize in providing top-quality ceiling fan installation services 
                ...
                <p>
                  Whether you need ceiling fan installation for your home or business, we have the expertise and 
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Us for Ceiling Fan Installation?</h3>
            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 sticky top-24">
                ...
                <ContactForm servicePreselect="Ceiling Fan Installation" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact us today for a free estimate on your ceiling fan installation project
          </p>
